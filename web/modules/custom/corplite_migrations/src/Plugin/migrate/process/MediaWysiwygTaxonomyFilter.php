 ...
 *   id = "media_wysiwyg_taxonomy_filter"
 * )
 */
class MediaWysiwygTaxonomyFilter extends ProcessPluginBase implements ContainerFactoryPluginInterface {
  ...
  public function transform($value, MigrateExecutableInterface $migrate_executable, Row $row, $destination_property) {
    ...
    $value = preg_replace_callback($pattern, function ($matches) use ($messenger, $tid) {
      if (str_contains($matches['tag_info'], 'chart')) {
        return;
      }
