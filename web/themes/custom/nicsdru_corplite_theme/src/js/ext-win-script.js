...
/* eslint-disable */
(function ($, Drupal) {
  Drupal.behaviors.nicsdruCorpliteExtWin = {
    attach: function attach(context) {
      ...
      $(once('elink', "#main-content a[href^='http'], #main-content a[href^='//'], #footer a[href*='http://'], #footer a[href*='https://']", context)).filter(function () {
